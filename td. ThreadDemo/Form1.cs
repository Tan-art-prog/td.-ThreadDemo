    ...
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < 26; i++)
            {
                ...
                myStream = myAssembly.GetManifestResourceStream("ThreadDemo.Resources." + c.ToString() + ".bmp");
        ...
        private void Form1_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            else
            {
                ...
                if (threadLst[newch - 65].start)
                {
                    ...
                    threadLst[newch - 65].suspend = false;
                    threadLst[newch - 65].t = new System.Threading.Thread(new ParameterizedThreadStart(Running));
